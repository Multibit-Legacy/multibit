...
/**
 * the command line view for the address book open at the receiving addresses
 * 
 * @author jim
 * 
 */
public class AddressBookReceivingView extends AbstractView {
    public AddressBookReceivingView(Localiser localiser, String viewDescription, InputStream inputStream, PrintStream printStream) {
