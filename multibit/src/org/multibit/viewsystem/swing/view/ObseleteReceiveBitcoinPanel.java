...
public class ObseleteReceiveBitcoinPanel extends JPanel implements DataProvider, View {
    ...
    public ObseleteReceiveBitcoinPanel(JFrame mainFrame, MultiBitController controller) {
