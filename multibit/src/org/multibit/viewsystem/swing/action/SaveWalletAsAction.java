...
public class SaveWalletAsAction extends AbstractAction {
     ...
     */
    public SaveWalletAsAction(Localiser localiser, ImageIcon icon, MultiBitFrame mainFrame) {
        super(localiser.getString("saveWalletAsAction.text"), icon);
        this.localiser = localiser;
        this.mainFrame = mainFrame;

        putValue(SHORT_DESCRIPTION, localiser.getString("saveWalletAsAction.tooltip"));
        putValue(MNEMONIC_KEY, localiser.getMnemonic("saveWalletAsAction.mnemonicKey"));
        // messageBox icon
