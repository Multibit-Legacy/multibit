...
public class DeleteWalletActionTest extends TestCase {
    ...
    public void testNoWalletSelected() throws Exception {
        ...
        // Create a new DeleteWalletAction to test.
        FontSizer.INSTANCE.initialise(controller);
        DeleteWalletAction deleteWalletAction = new DeleteWalletAction(controller, null, null);

        assertNotNull("deleteWalletAction was not created successfully", deleteWalletAction);

        // Execute.
        deleteWalletAction.actionPerformed(null);
