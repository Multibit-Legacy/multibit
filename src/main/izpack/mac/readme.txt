...
MultiBit 0.5.2alpha is a test version of MultiBit that supports
encrypted wallets. Please try it out cautiously.

This is NOT production code yet so please read the following notes:

1) If you have any MultiBit 0.5.0alpha encrypted wallets:

   + Open them in MultiBit 0.5.0alpha and do a 
     "File | Remove Password".
   + Close 0.5.0alpha.
   + Open them in MultiBit 0.5.2alpha. You can then re-encrypt them.

   The wallet storage in this version is the same as in 0.5.1alpha.
...
3) MultiBit 0.5.2alpha opens in 'portable mode'. It has its own 
