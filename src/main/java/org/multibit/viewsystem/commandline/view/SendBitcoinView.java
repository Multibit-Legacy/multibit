...
/**
 * the command line view for send bitcoin confirm
 * 
 * @author jim
 * 
 */
public class SendBitcoinView extends AbstractView {
    public SendBitcoinView(Localiser localiser, String viewDescription, InputStream inputStream, PrintStream printStream) {
