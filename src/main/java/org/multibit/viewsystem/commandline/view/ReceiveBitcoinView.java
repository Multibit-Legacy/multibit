 ...
 * 
 */
public class ReceiveBitcoinView extends AbstractView {
    public ReceiveBitcoinView(Localiser localiser, String viewDescription, InputStream inputStream, PrintStream printStream) {
