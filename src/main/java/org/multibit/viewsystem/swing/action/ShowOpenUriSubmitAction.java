...
public class ShowOpenUriSubmitAction extends AbstractAction {
     ...
     */
    public ShowOpenUriSubmitAction(MultiBitFrame mainFrame, MultiBitController multiBitController, ShowUriDialogDataProvider dataProvider,
            ShowOpenUriDialog showOpenUriDialog) {
        super(multiBitController.getLocaliser().getString("showOpenUriView.yesText"));
