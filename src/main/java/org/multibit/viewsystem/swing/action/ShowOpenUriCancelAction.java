...
//        Item showDialogItem = dataProvider.getData().getItem(BitcoinModel.OPEN_URI_SHOW_DIALOG);
        ...
        if (dataProvider != null) {
            ...
            controller.getCoreModel().setUserPreference(BitcoinModel.OPEN_URI_SHOW_DIALOG, openUriDialogAsString);                
        }
        
        // we do not want to use the uri as the user clicked cancel
        controller.getCoreModel().setUserPreference(BitcoinModel.OPEN_URI_USE_URI, "false");   
