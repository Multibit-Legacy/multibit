 ...
 *
 */
public abstract class BitcoinSubmitAction extends AbstractAction {
     ...
     */
    public BitcoinSubmitAction(BitcoinController bitcoinController, String textKey, String tooltipKey, String mnemonicKey,  Icon icon) {
