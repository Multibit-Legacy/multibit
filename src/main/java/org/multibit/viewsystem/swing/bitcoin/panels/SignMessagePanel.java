...
import org.multibit.viewsystem.swing.bitcoin.actions.SignMessageSubmitAction;
...
public class SignMessagePanel extends JPanel implements Viewable, WalletBusyListener {
     ...
     */
    public SignMessagePanel(MultiBitFrame mainFrame, BitcoinController bitcoinController) {
