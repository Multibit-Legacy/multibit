...
public class SendBitcoinPanel extends AbstractTradePanel implements DataProvider, View {
    ...
    protected JPanel createFormPanel() {
        ...
        addressTextField = new MultiBitTextField("", 35);
        ...
        pasteAddressButton = new MultiBitButton(pasteAddressAction);
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 7;
        constraints.gridy = 4;
        ...
        sendButton = new MultiBitButton(sendBitcoinConfirmAction);
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 6;
        constraints.gridy = 6;
