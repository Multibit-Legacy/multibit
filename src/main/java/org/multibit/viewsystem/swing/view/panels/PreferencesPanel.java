...
public class PreferencesPanel extends JPanel implements View, PreferencesDataProvider {
    ...
    public PreferencesPanel(Controller controller, CoreFrame mainFrame) {
        ...
        preferencePlugins = new HashSet<PreferencePlugin>();
    ...
    public void AddPreferencesPlugin(PreferencePlugin preferencePlugin)
    {
        this.removeAll();
        preferencePlugins.add(preferencePlugin);
        initUI();
        displayView();
    }
    ...
    public void displayView() {
        ...
        for(PreferencePlugin preferencePlugin : preferencePlugins)
        {
            preferencePlugin.displayView();
        }
    ...
    private void initUI() {
        ...
        for(PreferencePlugin preferencePlugin : preferencePlugins)
        {
            preferencePlugin.addToMainPanel(mainPanel);
        }
    ...
    private JPanel createAppearancePanel(int stentWidth) {
        ...
        Dimension preferredSize = new Dimension(textWidth, fontMetrics.getHeight());
    ...
    private JPanel createButtonPanel() {
        ...
        PreferencesSubmitActionGroup submitAction = new PreferencesSubmitActionGroup(controller,
                ImageLoader.createImageIcon(ImageLoader.PREFERENCES_ICON_FILE));
        
        submitAction.addPreferencesSubmitAction(new CorePreferencesSubmitAction(controller, this, mainFrame));
        
        for(PreferencePlugin preferencePlugin : preferencePlugins)
        {
             submitAction.addPreferencesSubmitAction(preferencePlugin.getPreferencesSubmitAction());
        }
    ...
    public int getViewId() {
        return MultiBitView.PREFERENCES_VIEW;
    }
