...
public class CheckPrivateKeysPanel extends JPanel implements Viewable, WalletBusyListener {
     ...
     */
    public CheckPrivateKeysPanel(BitcoinController bitcoinController, MultiBitFrame mainFrame) {
    ...
    private JPanel createButtonPanel() {
        ...
        checkPrivateKeysSubmitAction = new CheckPrivateKeysSubmitAction(this.bitcoinController, mainFrame, this,
