...
public class CreateNewReceivingAddressPanel extends JPanel {
    ...
    public CreateNewReceivingAddressPanel(MultiBitController controller, ReceiveBitcoinPanel receiveBitcoinPanel, CreateNewReceivingAddressDialog createNewReceivingAddressDialog) {
        super();
        ...
        setOpaque(false);
            ...
            CancelBackToParentAction cancelAction = new CancelBackToParentAction(controller, ImageLoader.createImageIcon(ImageLoader.CROSS_ICON_FILE), createNewReceivingAddressDialog);
            cancelButton = new MultiBitButton(cancelAction, controller);
            buttonPanel.add(cancelButton);

            createNewReceivingAddressSubmitAction = new CreateNewReceivingAddressSubmitAction(controller, createNewReceivingAddressDialog, this, walletPasswordField);
