...
public class ExportPrivateKeysPanel extends JPanel implements Viewable, WalletBusyListener {
    ...
    public void displayView() {
        ...
        if (outputFilename == null || "".equals(outputFilename) || 
                (walletFilenameForChosenOutputFilename != null && !walletFilenameForChosenOutputFilename.equals(controller.getBitcoinModel().getActiveWalletFilename()))) {
            outputFilename = createDefaultKeyFilename(controller.getBitcoinModel().getActiveWalletFilename());
            walletFilenameForChosenOutputFilename = controller.getBitcoinModel().getActiveWalletFilename(); 
    ...
    public void walletBusyChange(boolean newWalletIsBusy) {       
        ...
        if (controller.getBitcoinModel().getActivePerWalletModelData().isBusy()) {
            ...
            exportPrivateKeySubmitAction.putValue(Action.SHORT_DESCRIPTION, HelpContentsPanel.createTooltipText(controller.getLocaliser().getString("multiBitSubmitAction.walletIsBusy", new Object[]{controller.getBitcoinModel().getActivePerWalletModelData().getBusyOperation()})));
