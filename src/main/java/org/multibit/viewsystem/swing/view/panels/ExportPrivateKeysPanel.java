...
public class ExportPrivateKeysPanel extends JPanel implements Viewable, WalletBusyListener {
    ...
    public void walletBusyChange(boolean newWalletIsBusy) {       
        ...
        if (this.bitcoinController.getModel().getActivePerWalletModelData().isBusy()) {
            ...
            exportPrivateKeySubmitAction.putValue(Action.SHORT_DESCRIPTION, HelpContentsPanel.createTooltipText(controller.getLocaliser().getString("multiBitSubmitAction.walletIsBusy", new Object[]{this.bitcoinController.getModel().getActivePerWalletModelData().getBusyOperation()})));
