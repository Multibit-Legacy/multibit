...
import org.multibit.viewsystem.swing.bitcoin.panels.AbstractTradePanel;
...
public class WelcomePanel extends JPanel implements Viewable {
    ...
    private void initUI() {
        ...
        helpButton.setBorder(BorderFactory.createEmptyBorder(0, WelcomePanel.HELP_BUTTON_INDENT,
                WelcomePanel.HELP_BUTTON_INDENT, WelcomePanel.HELP_BUTTON_INDENT));
