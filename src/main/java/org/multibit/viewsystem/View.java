...
public interface View {
    ...
    public static final int SEND_BITCOIN_CONFIRM_VIEW = 3;  // obselete - swingified
    ...
    public static final int OPEN_WALLET_VIEW = 8;           // obselete - swingified
    public static final int SAVE_WALLET_AS_VIEW = 9;        // obselete - swingified
    public static final int VALIDATION_ERROR_VIEW = 10;     // obselete - swingified
