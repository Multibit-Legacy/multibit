...
public class SwatchGenerator {
    ...
    // these constants should migrate into a swatch model that is generated by a swatch designer
    ...
    public BufferedImage generateSwatch(String address, String amount, String label) {
       ...
       // get a byte matrix for the data
        ...
        int amountAdvance = getAdvance(emptyGraphics, amount + " BTC", amountFont);
        ...
        int swatchWidth = matrixWidth + 18 + widestTextAdvance + LEFT_TEXT_INSET + RIGHT_TEXT_INSET + WIDTH_OF_TEXT_BORDER * 2 + QUIET_ZONE_SIZE;
        ...
        g2.drawString(address, matrixWidth + QUIET_ZONE_SIZE, 
                matrixHeight - QUIET_ZONE_SIZE - WIDTH_OF_TEXT_BORDER - BOTTOM_TEXT_INSET);
        ...
        g2.drawString(amount + " BTC", matrixWidth + QUIET_ZONE_SIZE + WIDTH_OF_TEXT_BORDER, 
                QUIET_ZONE_SIZE  + TOP_TEXT_INSET + labelFont.getSize() + GAP_BETWEEN_TEXT_ROWS + amountFont.getSize());

        //long time1 = (new Date()).getTime();
        //System.out.println("SwatchGenerator#generateSwatch took " + (time1 - time0) + " millisec");
        return image;
    }
    ...
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null, "" , "Swatch Generator 1",
        ...
        JOptionPane.showMessageDialog(null, "" , "Swatch Generator 2",
                JOptionPane.INFORMATION_MESSAGE, icon);

        
        address = "15BGmyMKxGFkejW1oyf2Gwv3NHqeUP7aWh";
        amount = "0.423";
        label = "A longerer label xyzabc";

        swatch = swatchGenerator.generateSwatch(address, amount, label);
        icon = new ImageIcon(swatch);        
        JOptionPane.showMessageDialog(null, "" , "Swatch Generator 3",
                JOptionPane.INFORMATION_MESSAGE, icon);
        ...
        swatch = swatchGenerator.generateSwatch(address, amount, label);
        icon = new ImageIcon(swatch);        
        JOptionPane.showMessageDialog(null, "" , "Swatch Generator 4",
                JOptionPane.INFORMATION_MESSAGE, icon);
