...
/**
 * Main MultiBitInternal entry class.
 * 
 * @author jim
 */
public final class MultiBitInternal {

    private static final Logger log = LoggerFactory.getLogger(MultiBitInternal.class);
     ...
     */
    private MultiBitInternal() {
    }

    /**
     * Start MultiBitInternal user interface.
     * 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            log.info("Checking to see if this is the primary MultiBitInternal instance");
            String rawURI = null;
            ...
            if (!ApplicationInstanceManager.registerInstance(rawURI)) {
                ...
                log.debug("Another instance of MultiBitInternal is already running.  Exiting.");
                System.exit(0);
            }
            ...
            ApplicationInstanceManager.setApplicationInstanceListener(new ApplicationInstanceListener() {
                ...
                public void newInstanceCreated(String rawURI) {
                    ...
                    log.debug("New instance of MultiBitInternal detected...");
            ...
            log.debug("MultiBitInternal version = " + localiser.getVersionNumber());
            ...
            if (numberOfEarlyWalletsAsString == null || "".equals(numberOfEarlyWalletsAsString) || "null".equals(numberOfEarlyWalletsAsString)) {
                ...
                try {
                    ...
                    // If there is no active filename this is a new instance of MultiBitInternal so backup the new wallet when created.
            ...
            log.error("An unexpected error caused MultiBitInternal to quit.");
    ...
    public static void setCoreController(CoreController coreController ) {
        MultiBitInternal.controller = coreController;
        MultiBitInternal.coreController = coreController;
    }
    
    public static void setBitcoinController(BitcoinController bitcoinController) {
        MultiBitInternal.bitcoinController = bitcoinController;
    }
     
     public static void setExchangeController(ExchangeController exchangeController) {
        MultiBitInternal.exchangeController = exchangeController;
    }
}
